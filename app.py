...
# --------------------------------------------------
st.set_page_config(
    page_title="SPS Parts Optimization & PO Trigger Engine",
    layout="wide"
)
...
if uploaded_file:
    ...
    try:
        ...
        # --------------------------------------------------
        # RENAME CRITICAL SEGMENT COLUMN
        # --------------------------------------------------
        df.rename(
            columns={
        ...
        # --------------------------------------------------
        # CRITICAL SEGMENT FILTER
        # --------------------------------------------------
        segment_filter = st.sidebar.multiselect(

            "Select Critical Segment",

            options=df['Critical_Segment']
            .dropna()
            .unique(),

            default=df['Critical_Segment']
            .dropna()
            .unique()
        )
